...
module ChefConfig
  class WorkstationConfigLoader
    ...
    def chef_config_dir
      if @chef_config_dir.nil?
        ...
        (full_path.length - 1).downto(0) do |i|
          candidate_directory = File.join(full_path[0..i] + [Chef::Dist::USER_CONF_DIR])
    ...
    def locate_local_config
      ...
      PathHelper.home(Chef::Dist::USER_CONF_DIR) do |dot_chef_dir|
    ...
    def home_chef_dir
      @home_chef_dir ||= PathHelper.home(Chef::Dist::USER_CONF_DIR)
    end
