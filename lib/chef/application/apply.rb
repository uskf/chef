...
class Chef::Application::Apply < Chef::Application
  ...
  banner "Usage: #{Chef::Dist::EXEC}-apply [RECIPE_FILE | -e RECIPE_TEXT | -s] [OPTIONS]"
  ...
  def get_recipe_and_run_context
    ...
    recipe = Chef::Recipe.new("(#{Chef::Dist::EXEC}-apply cookbook)", "(#{Chef::Dist::EXEC}-apply recipe)", run_context)
    [recipe, run_context]
  end
